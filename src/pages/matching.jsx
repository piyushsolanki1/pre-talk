    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-4 text-gray-500">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center text-center">
        ...
        <div className="relative mb-10 flex h-32 w-32 items-center justify-center">
          ...
          <div className="absolute inset-3 animate-pulse rounded-full border-3 border-purple-400/30" />
        ...
        <div className="mt-8 flex items-center gap-3 rounded-full border border-[#24242F] bg-white px-5 py-3">
          ...
          <span className="text-sm text-gray-700">
            Searching through{" "}
            <span className="font-semibold text-gray-700">455</span> strangers
          </span>
        </div>
...
className="mt-8 inline-flex items-center gap-2 rounded-xl bg-purple-400 px-5 py-3 text-sm font-medium text-gray-700 transition hover:border-[#3a3a47] hover:bg-purple-500 hover:text-white">
          Cancel
        </button>
